  ...
  module GoteborgLogin
    module Gbgpub
      ...
      def self.sp_entity_id
        ...
        raise "Missing Gbgpub sp_entity_id configuration"
      end
      ...
      def self.assertion_consumer_service_url
        ...
        raise "Missing Gbgpub assertion_consumer_service_url configuration"
      end
      ...
      def self.idp_metadata_file
        if config.idp_metadata_file
          ...
          raise "Gbgpub idp_metadata_file '#{config.idp_metadata_file}' doesn't exist!"
        else
          raise "Missing Gbgpub idp_metadata_file configuration!"
        end
      end
